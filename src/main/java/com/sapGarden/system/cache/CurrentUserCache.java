...
public class CurrentUserCache implements Cache{
	...
	public CurrentUserCache(String name,MemcachedClient client){
		this.name=name;
		this.client=client;
	}
	@Override
	...
	public void put(Object key, Object value) {
		...
		try {
			...
			if(null == obj){
				...
				this.client.replace(objectToString(key), defaultWeight, value);
			}
		} catch (TimeoutException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
