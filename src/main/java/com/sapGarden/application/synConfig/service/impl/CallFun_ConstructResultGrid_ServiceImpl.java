...
@Service("callFun_constructResultGrid_ServiceImpl")
public class CallFun_ConstructResultGrid_ServiceImpl extends Abstract_ConstructJqgrid_Service{
	...
	public String construct(String type,SapDataCollection sapDataCollection){
		...
		if(constantObject!=null){
			...
			ConstructJqgridConfigModelService service  = constant.getConstructResultJqgridConfigModelService();
			if(service!=null){
