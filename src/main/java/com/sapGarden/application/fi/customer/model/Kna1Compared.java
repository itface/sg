...
@Entity
@Table(name="kna1_compared")
public class Kna1Compared implements Serializable{
...
//	@GeneratedValue(strategy = GenerationType.TABLE, generator = "kna1_compared_gen")
	...
	*/
	...
	public Kna1Compared(long sapclient,Kna1 skna1,Kna1 gkna1) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		...
		if(skna1!=null){
			...
			for(int j=0;j<fields.length;j++){
				...
				if(!name.equals("serialVersionUID")&&!name.equals("id")&&!name.equals("sapclient")&&!name.equals("garden_flag")){
					...
					Method method = Kna1Compared.class.getMethod(methodName, new Class[]{fieldType});
	...
	public double getUmsa1_old() {
		return umsa1_old;
	}
	public void setUmsa1_old(double umsa1_old) {
