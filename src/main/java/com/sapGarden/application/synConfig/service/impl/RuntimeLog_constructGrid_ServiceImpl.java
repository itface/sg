...
@Service("runtimeLog_constructGrid_ServiceImpl")
public class RuntimeLog_constructGrid_ServiceImpl extends Abstract_ConstructJqgrid_Service{
	...
	public String construct(String type,SapDataCollection sapDataCollection){
		...
		if(constantObject!=null){
			...
			ConstructJqgridConfigModelService service  = constant.getConstructLogJqgridConfigModelService();
			if(service!=null){
