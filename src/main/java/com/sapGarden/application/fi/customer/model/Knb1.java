...
public class Knb1 implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4588401392706444172L;
	@Id
//	@TableGenerator(name = "knb1_gen", //该表主键生成策略的名称,被@GeneratedValue.generator引用。
...
//	                pkColumnValue = "knb1_pk",//在持久化的表中，该生成策略所对应的主键
//	                initialValue = 100,             //默认主键值为50
//	                allocationSize = 1)           //每次主键值增加的大小
//	@GeneratedValue(strategy = GenerationType.TABLE, generator = "knb1_gen")
