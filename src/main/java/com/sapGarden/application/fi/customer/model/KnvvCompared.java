...
public class KnvvCompared implements Serializable{
	...
	*/
	...
	public KnvvCompared(long sapclient,Knvv sknvv,Knvv gknvv) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		...
		if(sknvv!=null){
			...
			for(int j=0;j<fields.length;j++){
				...
				if(!name.equals("serialVersionUID")&&!name.equals("id")&&!name.equals("sapclient")&&!name.equals("garden_flag")){
					...
					Method method = KnvvCompared.class.getMethod(methodName, new Class[]{fieldType});
