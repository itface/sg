...
@Service("runtimeMonitor_constructGrid_ServiceImpl")
public class RuntimeMonitor_constructGrid_ServiceImpl extends Abstract_ConstructJqgrid_Service{
	...
	public String construct(String type,SapDataCollection sapDataCollection) {
		...
		if(constantObject!=null){
			...
			ConstructJqgridConfigModelService service  = constant.getConstructMonitorJqgridConfigModelService();
			if(service!=null){
